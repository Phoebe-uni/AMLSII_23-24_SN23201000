...
def main_train(model_name = "SRResNet", iterations = 1000):
    ...
    best_srresnet_ckpt = TASK_FOLDER / "B_ckpt_srresnet_best.pth.tar"
    best_srgan_ckpt = TASK_FOLDER / "B_ckpt_srgan_best.pth.tar"
    best_srcnn_ckpt = TASK_FOLDER / "B_ckpt_srcnn_best.pth.tar"
    best_edsr_ckpt = TASK_FOLDER / "B_ckpt_edsr_best.pth.tar"


    info_file = TASK_FOLDER / f"B_{model_name}_train.txt"
    fig_head = TASK_FOLDER / f"B_{model_name}"
    title_head = f"Task B: {model_name}"
